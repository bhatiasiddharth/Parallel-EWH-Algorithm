 ...
 */
 ...
 n_blocks*=0.9375; //15/16
 //n_blocks*=0.96875;	//31/32
 Hash_table<<<n_blocks,block_dim>>>(devData,table,deVal,devPtr,devOff,count,SPT);  //invoke gpu kernel
